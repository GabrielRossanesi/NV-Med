...
4. Depois execute, nesta ordem: `04_storage.sql`, `05_production.sql`, `06_operational_scheduling.sql`, `08_user_profiles.sql`, `09_admin_deletions.sql`, `10_financial_reporting.sql`, `11_finance_module.sql`, `12_user_additional_permissions.sql` e `13_document_governance.sql`.
