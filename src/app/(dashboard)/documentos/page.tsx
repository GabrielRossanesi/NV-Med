...
function DocumentsPageContent() {
  ...
  const doctorExistsInOrg = orgDoctors.some(d => d.id === urlDoctorId);
  const initialDoctorId = doctorExistsInOrg ? urlDoctorId : 'all';
  ...
  if (
    ...
    const exists = orgDoctors.some(d => d.id === urlDoctorId);
    const nextDoctorId = exists ? urlDoctorId : 'all';
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      {(filterStatus !== 'all' || filterDocName !== 'all' || filterDocType !== 'all') && (
