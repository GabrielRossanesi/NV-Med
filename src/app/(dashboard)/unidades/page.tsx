    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-card-bg p-4 rounded-xl border border-card-border flex flex-col md:flex-row items-center gap-4">
        <div className="relative w-full md:flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 border border-border rounded-lg text-xs bg-background focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 transition"
          />
        </div>
        ...
        <div className="relative w-full md:w-40">
          <select
            ...
            className="w-full px-3 py-2 border border-border rounded-lg text-xs bg-background focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 transition"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredUnits.length > 0 ? (
          filteredUnits.map((unit) => (
            <div
              key={unit.id}
              className="bg-card-bg rounded-xl border border-card-border p-5 flex flex-col justify-between hover:border-primary/30 dark:hover:border-teal-550/20 transition duration-150"
            >
              <div>
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="bg-slate-100 dark:bg-slate-850 p-2 rounded-lg text-text-muted">
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-2">
                <Link
                  ...
                  className="px-3 py-1.5 rounded bg-slate-50 hover:bg-slate-100 dark:bg-slate-950 dark:hover:bg-slate-900 border border-border text-slate-600 dark:text-slate-300 font-semibold text-xs flex items-center gap-1 transition"
                >
                ...
                <button
                  ...
                  className="p-1.5 rounded hover:bg-red-50 dark:hover:bg-red-950/20 text-text-muted hover:text-red-600 dark:hover:text-red-400 transition"
                  title="Excluir"
                >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 backdrop-blur-sm p-4">
          <div className="bg-card-bg rounded-xl border border-slate-250 dark:border-slate-800 max-w-lg w-full max-h-[90vh] flex flex-col shadow-2xl animate-in zoom-in-95 duration-200">
            {/* Header */}
