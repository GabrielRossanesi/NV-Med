...
export const config = { matcher: ['/', '/login', '/definir-senha', '/auth/confirm', '/dashboard/:path*', '/escala/:path*', '/medicos/:path*', '/unidades/:path*', '/documentos/:path*', '/configuracoes/:path*', '/perfil/:path*', '/empresas/:path*', '/admin/:path*'] };
